...
def generate(
    ...
    with torch.no_grad():
        ...
        to_idle(clip) #very useful for limited gpu, you can offload the models to the cpu again
        ...
        # Each timestep indicates a noise level, in the scheduler we can tell the
        ...
        for i, timestep in enumerate(timesteps):
            ...
            # Remove noise prediceted by the UNET    
